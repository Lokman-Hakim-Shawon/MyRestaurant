...
const Testimonia = () => {
    return (
        <div className='py-4 h-[80vh] flex items-center justify-center my-4 bg-cover bg-center' style={{backgroundImage: `url(${img})`}}>
            {/* <img src={img} /> */}
            <div className='z-10  text-center bg-white w-[80%] lg:w-[80%] lg:p-24 py-4'>
