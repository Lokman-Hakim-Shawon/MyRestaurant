...
const MenuItemsBanner = ({heading,subheading,img}) => {
    return (
        <div className='py-4 h-[35vh] lg:h-[80vh] flex items-center justify-center my-4 bg-cover bg-center' style={{backgroundImage: `url(${img})`}}>
            {/* <img src={img} /> */}
...
export default MenuItemsBanner;