...
const Register = () => {
    return (
        <div className=' text-center  font-inter'>
            <h1 className='pt-24 text-4xl font-bold underline'>Registration</h1>
        <div className='lg:flex lg:flex-row-reverse lg:px-24 lg:pb-24 shadow-xl justify-between items-center'>
